...
//        String result = callURLAndParseResult("en", "vi", translatedText);
    ...
    @FXML
    void initialize() {
        assert engSpeakButton != null : "fx:id=\"engSpeakButton\" was not injected: check your FXML file 'OpenTextTranslatingPage.fxml'.";
        assert input != null : "fx:id=\"input\" was not injected: check your FXML file 'OpenTextTranslatingPage.fxml'.";
        assert output != null : "fx:id=\"output\" was not injected: check your FXML file 'OpenTextTranslatingPage.fxml'.";
        assert backButton != null : "fx:id=\"backButton\" was not injected: check your FXML file 'OpenTextTranslatingPage.fxml'.";
        assert translateButton != null : "fx:id=\"translateButton\" was not injected: check your FXML file 'OpenTextTranslatingPage.fxml'.";
